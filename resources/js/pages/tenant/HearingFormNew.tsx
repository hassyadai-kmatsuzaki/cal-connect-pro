...
const HearingFormNew: React.FC = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    slack_notify: false,
    slack_webhook: '',
    form_completion_message: '{{user_name}}様\n\nご回答ありがとうございました。\n内容を確認後、ご連絡させていただきます。',
  });
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      setTimeout(() => {
        navigate(`/hearing-forms/${response.data.data.id}`);
      }, 1000);
    } catch (error: any) {
            ...
            <CardContent>
              ...
              <Stack spacing={2}>
                ...
                <TextField
                  ...
                  helperText="フォームの目的や注意事項などを入力してください"
                />
              </Stack>
            </CardContent>
          </Card>
              ...
              <Stack spacing={2}>
                ...
                {formData.slack_notify && (
                  <TextField
                    ...
                    helperText="フォーム回答時に通知を送信するSlackのWebhook URLを入力してください"
                  />
                )}
              </Stack>
            </CardContent>
